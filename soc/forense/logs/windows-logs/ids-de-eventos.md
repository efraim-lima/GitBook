...
A partir disso é interessante correlacionar o framework [[CYBER]] Kill Chain, que descreve as etapas de um ataque cibernético e IDs de eventos específicos do [[soc/tools/operational-systems/windows/windows|windows]] que levantarão eventos que podem ser associados a cada etapa do incidente.
...
* ID de Evento 4688: Um novo processo foi criado (pode indicar [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de reconhecimento).
...
* ID de Evento 5156: A Plataforma de Filtragem do [[soc/tools/operational-systems/windows/windows|windows]] permitiu uma conexão (pode indicar tráfego C2).
* ID de Evento 5158: A Plataforma de Filtragem do [[soc/tools/operational-systems/windows/windows|windows]] bloqueou uma conexão.
