...
5. **Tools**:
   * O processo de analsar as ferramentas usadas pelo atacante, como exploits, backdoors, etc. possui uma dificuldade muito alta para o atacante, já que alterar ou substituir ferramentas pode exigir [[fatec/Pesquisa/Pesquisa/ferramentas/desenvolvimento|desenvolvimento]] adicional ou encontrar alternativas adequadas.
