...
Podemos iniciar a compreensão a partir dos menores fragmentos de um sistema que podem ser analisados e que são constantes [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] para quem for atuar na área de segurança: eventos.
...
Vamos olhar com mais atenção para [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] eventos para que possamos compreender como este elemento se apresenta no dia a dia em sistemas.\
\
...
Porém, nem todos eventos podem ser considerados como legítimos e corretos, se tomarmos como contexto [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] eventos mencionados anteriormente, podemos modificar alguns pontos fundamentais que transformariam estes eventos em eventos suspeitos, assim teríamos:
...
* [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] como [[softwares]] e equipamentos;
...
Um bom ferramental para um bom tratamento de incidentes deve considerar [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] diversos cenários em que podemos estar inseridos de acordo com as características do incidente que estaremos investigando. Mas algumas das mais mencionadas e referidas são:

* um laptop adicional, para cada membro do time [[soc/forense/forense|forense]], para preservar as provas e evidencias da devida forma (ATENÇÃO: o sistema deve estar configurado apropriadamente para receber [[soc/tools/malwares|malwares]] e arquivos potencialmente danosos ao sistema e isso deve ser feito de uma forma que preserve quaisquer outros elementos da organização);
* uma boa ferramenta de aquisição e análise de imagens com propósito [[soc/forense/forense|forense]];
* [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de memória e captura;
* [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de captura e análise da resposta em tempo real;
* [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de analise de [[logs]];
* [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de captura e análise de pacotes de rede;
* cabos de rede e switches;
* blocos de nota;
* HDs para imagens forenses;
* cabos de força;
* chaves de fenda, pinças e outras [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] relevantes para reparar ou desmontar dispositivos de hardware, se necessário;
...
O ambiente empresarial também deve estar pronto para passar por incidentes potencialmente críticos e para isso temos algumas [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] que podem auxiliar a transformar o ambiente das organizações mais seguro.
...
* EDR: é uma ferramenta que foca em detectar as principais ameaças que se originam na internet e tem como alvo [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] endpoints de uma organização (estações de [[trabalho]], impressoras por exemplo)
...
* Endpoint Hardening: aqui pode-se tomar uma série de medidas que focam no processo de se assegurar que [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] endpoints estão devidamente assegurados
