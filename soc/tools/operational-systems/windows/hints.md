...
* Entrar no editor de registror do [[soc/tools/operational-systems/windows/windows|windows]]
...
Outra alternativa para montagem de unidades no [[soc/tools/operational-systems/windows/windows|windows]]:\
&#x20;
...
Caso tenha duvidas da veracidade e qualidade do material recomendo fortemente formatar a mídia com [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] passos a seguir:\
\
lsblk => listar [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] dispositivos conectados
...
Observação: \*\*windump\*\* é uma variante do Microsoft [[soc/tools/operational-systems/windows/windows|windows]] do \*\*tcpdump\*\*. \*\*tshark\*\* é uma ferramenta de linha de comando Wireshark semelhante a \*\*tcpdump\*\*.
...
* Costura NAT - Simplifica [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] fluxos com entradas NAT.

Há um canal Cisco Stealthwatch no YouTube que fornece muitos detalhes sobre o Stealthwatch e seus usos.

[[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] sistemas SIEM incluem as seguintes funções essenciais:

* Análise [[soc/forense/forense|forense]] — A capacidade de pesquisar [[logs]] e registros de eventos de fontes em toda a organização. Ele fornece informações mais completas para análise [[soc/forense/forense|forense]].
...
* Reporting - Reporting apresenta [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] dados de eventos correlacionados e agregados em monitoramento em tempo real e resumos de longo prazo.
...
* Informações de postura, como se o dispositivo é compatível com a política de segurança, tem arquivos antivírus atualizados e é atualizado com [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] patches de SO mais recentes.&#x20;

Teclar Win + R e acionar:

* netplwiz: verificar se usuários são [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] corretos;
* msconfig: Ir em opções avançadas de INICIALIZAÇÃO e ver se [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] processadores estão bloqueados
