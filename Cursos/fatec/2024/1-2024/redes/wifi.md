...
BSS: Basic service set => em casas em em SOHO ad-hoc -> rede itinerante, vem dos conceitos militares onde todos conseguem se comunicar entre si, sendo capaz de detectar se [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] soldados estão em ação.
...
\---> Miscrosoft Active Directory, SAMBA 4 (inclusive o AD não detecta que é [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]])
