...
D de DIAGNÓSTICO => analisaremos [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] sintomas e [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] sinais com o objetivo de descobrir qual é a causa do problema.
...
S de SOLUÇÃO => são [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] passos necessários para resolver, eliminar a causa do problema e, consequentemente o problema. Ex.: o médico examina, analisa e descobre qual a causa, por fim te da uma receita (remédio, quantidade e tempo em que se deve tomar)
...
\-> Problema: notebook fica com tela azul; -> Diagnóstico: após ligar o computador nota-se varios códigos hexa no monitor; -> Causa: [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]] com arquivos corrompidos (exemplo, muito comum em desktop que desliga sem nobreak) -> Solução: reinstalar o [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]]; -> Manutenção: pegar a ISO, instalar o [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]], instalar [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/aplicativos|aplicativos]]. Usar uma hd padrão para extrair a memória presente.
