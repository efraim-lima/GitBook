...
[[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] programas estão na memória secundária, pois a principal é volátil. -> no endereço 0 da memória estão as informações do boot

***

III) dispositivos de entrada [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] dispositivos de entrada são [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] elementos que conectam nosso mundo analógico ao mundo digital, fornecendo dados para serem processados.
...
V) barramentos Implementa todos [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] componentes permitindo o tráfego de instruções e dados no sistema.
