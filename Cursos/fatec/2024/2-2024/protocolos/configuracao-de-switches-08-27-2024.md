...
Aqui temos o processo de configuração de uma rede que utiliza switches camada 2 e o script que pode ser utlizado para esta configuração. Tentarei anexar [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] [[scripts]] aqui e deixar em texto plano também.
...
\#configurar [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] swithes apenas até a porta 5 e [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] hosts a partir da 6, para que a comunicação seja restringida naquela vlan para [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] hosts a partir desta porta
...
\#configuração do router: cada interface precisa ter um IP específico pois estas serão [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] gateways padrão de cada switch, e estes IPs precisam ser [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] primeiros IPs úteis de cada cada rede presente em cada switch; imprescindível inserir mais interfaces no roteador para comportar a quantidade de interfaces, no caso foram inseridos 4 Ethernets para comportar as conexões
