...
Introdução a alguns conceitos de redes e de processos em que [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] [[PROTOCOLOS]] se desenrolam nos meios e no sistema como um todo, por exemplo, como analisarmos cada nó na rede para sabermos qual o caminho físico que [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] pacotes estão fazendo quando usamos o traceroute (tracert) e qual a relação dos IPs com [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] nós na rede real (cabeada, basicamente);

Apresentou as [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] como ip address detail, que apresentam dados dos nós de forma física.

Quando for enviar o [[Projeto]] para o professor via email, usar no assunto do email "SEGNA3" para identificar a turma e no corpo [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] integrantes.
...
Para calcular a máscara decimal partiremos da máscara binária, como o valor de cada bit decimal ativo seria correspondente ao seu valor basta somar suas representações, por exemplo, no primeiro e no segundo octeto possuímos todos [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] bits ativos, portanto basta somar suas posições, por exemplo:
...
Agora sim, somando todos [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] bits ativos (ou subtraindo a soma dos inativos do valor 255, o valor fechados do byte) chegaremos a: 128 + 64 + 32 + 16 + 8 + 4 = 252, ou então, pela lógica reversa: 255 - (2 + 1) = 252.
