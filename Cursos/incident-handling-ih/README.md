...
Podemos iniciar a compreensão a partir dos menores fragmentos de um sistema que podem ser analisados e que são constantes [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] para quem for atuar na área de [[Segurança]]: eventos.

Basicamente eventos são elementos compiladas em um sistema que são provenientes de ações tomadas num sistema seja por um usuário ou por aplicações presentes no sistema, geralmente essas ações são transmitidas através de [[CyberSecurity/Course/forense/logs/logs]] pelos sistemas. A estes elementos podemos chamar de "eventos".

Vamos olhar com mais atenção para [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] eventos para que possamos compreender como este elemento se apresenta no dia a dia em sistemas.\
\
...
Porém, nem todos eventos podem ser considerados como legítimos e corretos, se tomarmos como contexto [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] eventos mencionados anteriormente, podemos modificar alguns pontos fundamentais que transformariam estes eventos em eventos suspeitos, assim teríamos:
...
* [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] como [[softwares]] e equipamentos;
...
Um bom ferramental para um bom tratamento de incidentes deve considerar [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] diversos cenários em que podemos estar inseridos de acordo com as características do incidente que estaremos investigando. Mas algumas das mais mencionadas e referidas são:

* um laptop adicional, para cada membro do time [[CyberSecurity/Course/forense/forense|forense]], para preservar as provas e evidencias da devida forma (ATENÇÃO: o sistema deve estar configurado apropriadamente para receber [[CyberSecurity/Course/tools/malwares|malwares]] e arquivos potencialmente danosos ao sistema e isso deve ser feito de uma forma que preserve quaisquer outros elementos da organização);
* uma boa ferramenta de [[Aquisição]] e análise de imagens com propósito [[CyberSecurity/Course/forense/forense|forense]];
* [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de memória e captura;
* [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de captura e análise da resposta em tempo real;
* [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de analise de [[CyberSecurity/Course/forense/logs/logs]];
* [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de captura e análise de pacotes de rede;
* cabos de rede e switches;
* blocos de nota;
* HDs para imagens forenses;
* cabos de força;
* chaves de fenda, pinças e outras [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] relevantes para reparar ou desmontar dispositivos de hardware, se necessário;
...
O ambiente empresarial também deve estar pronto para passar por incidentes potencialmente críticos e para isso temos algumas [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] que podem auxiliar a transformar o ambiente das organizações mais seguro.

* SIEM: coleta [[CyberSecurity/Course/forense/logs/logs]] (eventos) de todos dispositivos conectados (e seus sensores configurados) na rede, para o prin
...
* EDR: é uma ferramenta que foca em detectar as principais ameaças que se originam na internet e tem como alvo [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] endpoints de uma organização (estações de [[CyberSecurity/fatec/Pesquisa/Trabalho/Trabalho]], impressoras por exemplo)
...
* Endpoint Hardening: aqui pode-se tomar uma série de medidas que focam no processo de se assegurar que [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] endpoints estão devidamente assegurados
  ...
  * Bloquear a comunicação entre estações de [[CyberSecurity/fatec/Pesquisa/Trabalho/Trabalho]] e tráfego de saída para LOLBins
* [[Segurança]] de Rede: assim como proteger as estações de [[CyberSecurity/fatec/Pesquisa/Trabalho/Trabalho]] é importante, proteger a rede também é um processo importantíssimo, sendo uma das camadas mais críticas a ser protegida. Com isso podemos tomar algumas medidas
