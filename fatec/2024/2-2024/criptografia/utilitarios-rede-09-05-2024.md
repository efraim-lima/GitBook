...
6. **Camada 6 - Apresentação**
   ...
   - **Linux**: Similar ao Windows, geralmente, a análise é feita em camadas superiores ou com ferramentas de [[fatec/Pesquisa/Pesquisa/ferramentas/desenvolvimento|desenvolvimento]] que tratam da codificação e decodificação de dados.
