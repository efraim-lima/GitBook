...
Introdução a alguns conceitos de redes e de processos em que [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] [[PROTOCOLOS]] se desenrolam nos meios e no sistema como um todo, por exemplo, como analisarmos cada nó na rede para sabermos qual o caminho físico que [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] pacotes estão fazendo quando usamos o traceroute (tracert) e qual a relação dos IPs com [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] nós na rede real (cabeada, basicamente);

Apresentou as [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] como ip address detail, que apresentam dados dos nós de forma física.

Quando for enviar o projeto para o professor via email, usar no assunto do email "SEGNA3" para identificar a turma e no corpo [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] integrantes.
...
Agora sim, somando todos [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] bits ativos (ou subtraindo a soma dos inativos do valor 255, o valor fechados do byte) chegaremos a: 128 + 64 + 32 + 16 + 8 + 4 = 252, ou então, pela lógica reversa: 255 - (2 + 1) = 252.
