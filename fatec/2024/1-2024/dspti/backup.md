...
II) [[notas/16.0/Backup/Backup|Backup]] - c'opia de segurança de arquivos sens'iveis ao neg'ocio da empresa -> ARQUIVOS: no [[soc/tools/operational-systems/linux/linux|linux]] tudo e um arquivo --> para n'[[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]], arquivo e uma sequencia bin'aria finita de (1011101......1) que possui uma informaç\~ao intr'inseca
...
[[notas/16.0/Backup/Backup|Backup]] Full -> é uma cópia completa de todos [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] arquivos sensíveis em um único volume
...
* desvantagens: o restore é mais complexo, precisa pegar o Full, o ultimo diferencial e todos [[fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] Incrementais até o ultimo, em forma cronológica
