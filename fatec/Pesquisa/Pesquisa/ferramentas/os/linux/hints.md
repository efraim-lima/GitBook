...
Sguil, é o console do analista de segurana cibernética em uma versão especial do [[soc/tools/operational-systems/linux/linux|linux]] chamada Security Onion. O Security Onion é um conjunto de [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de código aberto que trabalham juntas para análise de segurança de rede.

A tabela lista algumas [[fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] que são freqüentemente encontradas em um [[soc]].
