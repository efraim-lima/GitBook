 desvio padrão potencializa e evidencia as diferenças em uma quantidade de dados, o quadrado do desvo padrão apresenta 

primeiro precisamos primeiro calcular o valor total, depois [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] desvios de cada elemento na tabelaa
...
Numa tabela de Classes usamos [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] pontos medios de cada classe (linha) e isso será o Xi, a partir daí basta fazer como na tabela de frequancia.
...
2. Feito isso precisamos enontrar o h:
 - Organizar [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] elementos por ordem
