Dentro do [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]] server podemos criar uma estrutura de dependẽncias dentro das formas organizacionais baseando-se na estrutura lógica mais apropriada para a organização da empresa como um todo
...
Ao adicionar uma nova estação de [[CyberSecurity/fatec/Pesquisa/Trabalho/Trabalho]], no domínio devemos devemos ir em 
...
- no servidor, ao fazer a instalação, precisamos configurar pontos cruciais:
    - Instalar [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] serviços necessários
