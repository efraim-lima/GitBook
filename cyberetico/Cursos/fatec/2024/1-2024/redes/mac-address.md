...
SSID => nme da rede BSSID => endereço MAC (localiza a placa de rede) --> no momento da aula o MAC foi um hexa com base 16 no padrão Unix, ou seja, FF:FF:FF:FF:FF:FF (usando separadores ":"), em máquinas [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]] usa-se o padrão FF-FF-FF-FF-FF-FF, em máquinas IOS ou Cisco usa-se o padrão FFFF.FFFF.FFFF.

MAC = endereço físico (placa de rede) IP = endereço lógico (protocolo de endereçamento) -> ambos se correlacionam

[[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] primeiros 6 dígitos identificam o fabricante e o numero de série (ou seja, [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] primeiros 64 bytes)
...
[[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] 6 primeiros bytes identificam para onde o pacote está indo e [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] 6 demais de onde está vindo
