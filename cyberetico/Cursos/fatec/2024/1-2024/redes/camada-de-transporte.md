...
Encontrando [[portas]] registradas no [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]]:

/etc/servces

Encontrando [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] sockets conectados na rede: sudo netstat -putan sudo ss -putan'

Analisando [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] [[CyberSecurity/Course/forense/logs/logs]] dos ultimos processos: sudo tail -f auth.log

[[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] hackers atacam [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] sites por meio de proxy Random Socks Server -> Proxy Chains, são maquinas na rede que estão aleatoriamente na rede e ficam ligadas apenas em horários especificos, assim desligam estes servidores e não podem mais ser identificados
...
Para transportar dados muito grandes pela rede, o [[tcp]] fragmenta [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] pacotes e identifica o Sequence Number de cada frame para que possa ser novamente identificado na chegada e [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] dados (informação) sejam remontados no fim garantindo sua integridade.
...
O processo de investigar [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] processos no servidor é feito durante o [[handshake]]
