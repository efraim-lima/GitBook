...
MA, R. Anomaly detection for [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]] system log - University of Twente Student Theses. Utwente.nl, 2020. Disponível em: [https://essay.utwente.nl/83142/](https://essay.utwente.nl/83142/). Acesso em: 10 dez. [[2024]].

{% file src="../../../../.gitbook/assets/Anomaly detection for [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]] System Log.pdf" %}
Anomaly detection for [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]] System log
{% endfile %}
...
{% file src="../../../../.gitbook/assets/Intro to Log File Analysis (1).pdf" %}
...
Secure Data Deletion for [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]] File Systems | [https://www.usenix.org/legacy/events/sec01/full\_papers/bauer/](https://www.usenix.org/legacy/events/sec01/full_papers/bauer/)
...
YAGEMANN, Carter; NOUREDDINE, Mohammad A; WAJIH UL HASSAN; _et al_. Validating the Integrity of Audit [[CyberSecurity/Course/forense/logs/logs]] Against Execution Repartitioning Attacks. 2021.

{% file src="../../../../.gitbook/assets/Validating the Integrity of Audit [[CyberSecurity/Course/forense/logs/logs]] Against Execution.pdf" %}
Validating the Integrity of Audit [[CyberSecurity/Course/forense/logs/logs]] Against Execution Repartitioning Attacks
{% endfile %}

Verificar a Integridade dos [[CyberSecurity/Course/forense/logs/logs]] | [https://www.beyondtrust.com/blog/entry/unix-linux-security-log-integrity-important](https://www.beyondtrust.com/blog/entry/unix-linux-security-log-integrity-important)
...
Checando a Integridade dos [[CyberSecurity/Course/forense/logs/logs]] | [https://digital-library.theiet.org/doi/10.1049/cp.2013.2026](https://digital-library.theiet.org/doi/10.1049/cp.2013.2026)

SUTTON, Andrew ; SAMAVI, Reza. Blockchain Enabled Privacy Audit [[CyberSecurity/Course/forense/logs/logs]]. Lecture Notes in Computer Science, p. 645–660, 2017.

{% file src="../../../../.gitbook/assets/Blockchain Enabled Privacy Audit [[CyberSecurity/Course/forense/logs/logs]].pdf" %}
Blockchain Enabled Privacy Audit [[CyberSecurity/Course/forense/logs/logs]]
{% endfile %}

Compilado de datasets de [[CyberSecurity/Course/forense/logs/logs]] para analises de IA | [https://github.com/logpai/loghub](https://github.com/logpai/loghub)

\####################################################################

MALIN, Cameron H; CASEY, Eoghan ; AQUILINA, James M. Malware forensics field guide for [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]] systems : digital forensics field guides. Waltham, Ma: Syngress, 2014.

{% file src="../../../../.gitbook/assets/Malware Forensics Field Guide for [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]] Systems - PDF Room.pdf" %}
Malware Forensics Field Guide for [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]] Systems
{% endfile %}

MALIN, Cameron H; CASEY, Eoghan; AQUILINA, James M; _et al_. Malware forensic field guide for [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]] systems digital forensics field guides. \[s.l.]: Amsterdam Elsevier Rockland, Mass. Syngress Waltham, Mass. Syngress, 2012.

{% file src="../../../../.gitbook/assets/Malware Forensics Field Guide for [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]] Systems.pdf" %}
Malware Forensics Field Guide for [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]] Systems
{% endfile %}
