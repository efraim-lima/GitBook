...
Para dicas de [[CyberSecurity/Course/soc]] neste sistema operacional: [windows](../../../../../soc/tools/operational-systems/windows/ "mention")

ESTUDAR CMDLETS

* [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] dados que o arquivo contém são armazenados no atributo $DATA;
* fluxos de dados alternativos (ADSs) podem ser usados para injetar [[CyberSecurity/Course/tools/malwares|malwares]] no sistema pois é facil ocultar dados em um ADS. Ex.: No sistema de arquivos NTFS, um arquivo com um ADS é identificado após o nome do arquivo e dois pontos, por exemplo, Testfile.txt:ADS.
* pra ver se há um arquivo ads no [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]] precisamos usar o atributo dir /r.
...
* Systeminfo : todos [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] dados do PC como fabricantes, placas NAT, chipset e afins
...
Organizar a estrutura de memoria do [[CyberSecurity/Course/tools/operational-systems/windows/windows|windows]] constantemente
