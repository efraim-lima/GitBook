...
Para dicas de [[CyberSecurity/Course/soc]] neste sistema operacional: [linux](../../../../../soc/tools/operational-systems/linux/ "mention")

[[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]] é uma ferramenta flexivel que permite instalação de elementos independetemente e também possui diversas distribuições mantidas por empresas e pela comunidade. Uma distro potente e que será estudada mais pra frente é a Security Onion, que possui a ferramenta Sguil.

Sguil, é o console do analista de segurana cibernética em uma versão especial do [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]] chamada Security Onion. O Security Onion é um conjunto de [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] de código aberto que trabalham juntas para análise de [[Segurança]] de rede.

A tabela lista algumas [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/ferramentas|ferramentas]] que são freqüentemente encontradas em um [[CyberSecurity/Course/soc]].
