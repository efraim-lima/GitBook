[[CyberSecurity/Desenvolvimento/Desenvolvimento]]
...
Foi desenvolvida em [[Java]] para fins de aprendizado do desenvolvedor Efraim Lima, mas o objetivo é ter uma forma de tornar este código aplicável a outras plataformas além do [[CyberSecurity/Course/tools/operational-systems/linux/linux|linux]].
...
├── etc/
│   ├── Capture.[[Java]]                ← vai ser refatorado para [[CyberSecurity/fatec/Pesquisa/Pesquisa/ferramentas/os/os|os]] próximos commits
